...
* We are downloading a set of sample images with labels and coordinates for our classes from the https://storage.googleapis.com/openimages/web/index.html[OpenImages website,window=_blank].
